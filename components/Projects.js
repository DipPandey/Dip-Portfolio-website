const Projects = () => {
    const projects = [
        ...
        },
        {
            ...
            "description": "A simple signup/login web application with a users dashboard displaying their log activities. Admins can monitor and manage user activities efficiently.",
